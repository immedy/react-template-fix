...
export default function RefAmbulan() {
                    ...
                    <ComponentCard
                        ...
                        headerRight={
                            <div class="hidden h-11 items-center gap-0.5 rounded-lg bg-gray-100 p-0.5 lg:inline-flex dark:bg-gray-900">
                                <button class="text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white shadow-theme-xs text-gray-900 dark:text-white bg-white dark:bg-gray-800">All Invoices</button>
                                <button class="text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white text-gray-500 dark:text-gray-400">Unpaid</button>
                                <button class="text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white text-gray-500 dark:text-gray-400">Draft</button>
                                <button class="text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white text-gray-500 dark:text-gray-400">Draft</button>
                                </div>
                        }>
  ...
  <div>
      ...
      <table class="min-w-full">
        <thead>
          <tr class="border-y border-gray-200 dark:border-gray-800">
            <th class="px-6 py-3 text-left text-sm font-normal text-gray-500 first:pl-0 dark:text-gray-400">
              Name
            </th>
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
          <tr>
            <td class="px-6 py-3 text-left whitespace-nowrap first:pl-0">
              <div class="flex gap-3 pl-2">
                ...
                <p class="text-sm font-normal text-gray-700 dark:text-gray-400">
                  Invoice #012 - May 2024
                </p>
              </div>
            </td>
            <td class="px-6 py-3 text-sm font-normal whitespace-nowrap text-gray-700 dark:text-gray-400">
              May 01, 2024
            </td>
            <td class="px-6 py-3 text-sm font-normal whitespace-nowrap text-gray-700 dark:text-gray-400">
              $120.00
            ...
            <td class="px-6 py-3">
              <span class="inline-flex items-center justify-center gap-1 rounded-full px-2.5 py-0.5 text-sm font-medium bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500">
                Paid
              </span>
            </td>
            <td class="px-6 py-3">
              <div class="flex justify-end gap-2">
                <button class="shadow-theme-xs inline-flex h-9 w-9 items-center justify-center rounded-lg border border-gray-300 text-gray-500 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="21"
                    height="20"
          ...
          <tr>
            ...
            <td class="px-6 py-3">
              <span class="inline-flex items-center justify-center gap-1 rounded-full px-2.5 py-0.5 text-sm font-medium bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500">
                Unpaid
              </span>
            </td>
            <td class="px-6 py-3">
    ...
    <div class="rounded-b-xl border-t border-gray-200 px-6 py-4 dark:border-gray-800">
      ...
      <div class="flex items-center justify-between gap-8 bg-gray-50 dark:bg-white/[0.03] p-4 rounded-lg sm:p-0 dark:sm:bg-transparent sm:bg-transparent">
        <button
          disabled=""
          class="shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 sm:px-3.5 sm:py-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 opacity-50 cursor-not-allowed"
        >
          <svg
            class="fill-current"
            width="20"
        ...
        <ul class="hidden items-center gap-0.5 sm:flex">
          <li>
            <button class="flex h-10 w-10 items-center justify-center rounded-lg text-sm font-medium bg-brand-500 text-white hover:bg-brand-500 hover:text-white">
              1
            </button>
          </li>
          <li>
            <button class="flex h-10 w-10 items-center justify-center rounded-lg text-sm font-medium text-gray-700 hover:bg-brand-500 hover:text-white dark:text-gray-400 dark:hover:text-white">
              2
            </button>
          </li>
          <li>
        ...
        <button class="shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 sm:px-3.5 sm:py-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 hover:bg-gray-50 hover:text-gray-800 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
